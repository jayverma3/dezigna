...
// === Logging ===
file_put_contents(__DIR__ . "/php_debug_log.txt", "=== Contact Form Script Started: " . date("Y-m-d H:i:s") . " ===\n", FILE_APPEND);
...
$scheduledDate  = $conn->real_escape_string($data["scheduledDate"] ?? null);
...
(services, firstName, lastName, email, phone, message, bestWay, bestTime, terms, scheduledDate)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
